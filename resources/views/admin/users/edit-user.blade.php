        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-inline" method="post" action="{{ route('update-user', $user->id) }}">
                    ...
                    <input type="text" id="name" name="name" class="form-control mb-2 mr-sm-2" style="background-color: white !important; color: #0a0a0a !important;" placeholder="Name" value="{{ old('name', $user->name) }}">

                    <label class="sr-only" for="email">User Email</label>
                    <input type="email" id="email" name="email" class="form-control mb-2 mr-sm-2" style="background-color: white !important; color: #0a0a0a !important;" placeholder="Email" value="{{ old('email', $user->email) }}">

                    <label class="sr-only" for="phone">User Phone</label>
                    <input type="text" id="phone" name="phone" class="form-control mb-2 mr-sm-2" style="background-color: white !important; color: #0a0a0a !important;" placeholder="Phone" value="{{ old('phone', $user->phone) }}">

                    <label class="sr-only" for="address">User Address</label>
                    <input type="text" id="address" name="address" class="form-control mb-2 mr-sm-2" style="background-color: white !important; color: #0a0a0a !important;" placeholder="Address" value="{{ old('address', $user->address) }}">
